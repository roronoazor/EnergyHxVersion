...
from PyQt5.QtWidgets import (
    ...
    QLabel, QComboBox, QDoubleSpinBox, QLineEdit, QStackedWidget, QMainWindow,
...
from .get_site_data import get_site_data_battery_design
import matplotlib
...
class BatteryDesign(QWidget):
    ...
    def initUI(self):
        ...
        # First Page
        self.display_var = QWidget()
        self.display_var.setObjectName("display_var")

        self.grid_display_var = QGridLayout(self.display_var)
        self.grid_display_var.setObjectName("grid_display_var")

        self.grid_display_var.setColumnStretch(1, 4)
        self.grid_display_var.setColumnStretch(2, 4)

        self.grid_display_var.addWidget(self.horizontalGroupBox)
        self.grid_display_var.addWidget(self.horizontalGroupBox2)
        self.grid_display_var.addWidget(self.horizontalGroupBox3)

        # Second Page
        self.display_plot = QWidget()
        self.display_plot.setObjectName("display_plot")

        self.grid_display_plot = QVBoxLayout(self.display_plot)
        self.grid_display_plot.setObjectName("grid_display_plot")

        self.label_opt_result = QLabel("Optimum Battery Option")
        self.grid_display_plot.addWidget(self.label_opt_result)
        ...
        icon11 = QIcon()
        icon11.addPixmap(QPixmap("./icons/refresh-button.png"), QIcon.Normal, QIcon.Off)
        self.back_btn.setIcon(icon11)
        ...
        icon11 = QIcon()
        icon11.addPixmap(QPixmap("./icons/refresh-button.png"), QIcon.Normal, QIcon.Off)
        self.plot_btn.setIcon(icon11)
        self.plot_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.plot_btn.setAutoRaise(True)
        self.plot_btn.setObjectName("plot_btn")

        _translate = QtCore.QCoreApplication.translate
        self.back_btn.setText(_translate("display_plot", "Back"))
        self.plot_btn.setText(_translate("display_plot", "Plot"))


        self.btn_layout.addWidget(self.plot_btn)
        self.btn_layout.addWidget(self.back_btn)
        
        self.grid_display_plot.addWidget(self.btn_widget)
        ...
        self.grid_display_plot.addWidget(self.plotWidget)

        self.plot_btn.clicked.connect(self.optimize)
        self.back_btn.clicked.connect(self.displayVar)

        # mainLayout = QGridLayout()
        # mainLayout.setObjectName("displayLayout1")
        # mainLayout.setColumnStretch(1, 4)
        # mainLayout.setColumnStretch(2, 4)
        # mainLayout.addWidget(self.horizontalGroupBox)
        # mainLayout.addWidget(self.horizontalGroupBox2)
        # mainLayout.addWidget(self.horizontalGroupBox3)

        self.displayLayout = QGridLayout()
        
        self.main_display.addWidget(self.display_var)
        self.main_display.addWidget(self.display_plot)

        self.displayLayout.addWidget(self.main_display)
    ...
    def createGridLayout3(self):
        ...
        btn.clicked.connect(self.displayPlot)
...
if __name__ == '__main__':
    ...
    mainwin = QMainWindow()
    ex = BatteryDesign(mainwin)
    get_site_data_battery_design(12, 8, 15, 3, 6, 7, 11, 1)
    ex.show()
    # ex.showMaximized()
    sys.exit(app.exec_())
